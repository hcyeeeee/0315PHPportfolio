  ...
  if(!isset($_SESSION['aboutmeme'])){
    $aboutmeme=$Aboutmeme->find(1);
    $aboutmeme['aboutmeme']++;
    $Aboutmeme->save($aboutmeme);
    $_SESSION['aboutmeme']=$aboutmeme['aboutmeme'];
  }

// $Aboutme->save(['id'=>2,'aboutme'=>$_POST['aboutme']]);


<span class="t"><?=$Aboutme->find(1)['name'];?></span>
            <span class="t"><?=$Aboutme->find(1)['about'];?></span>
